...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/split-array-into-minimum-subsets/1)

## Solved On
29 Jul 2026 at 02:54 am

<h2><a href="https://www.geeksforgeeks.org/problems/split-array-into-minimum-subsets/1">Split Array into Minimum Subsets</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of distinct positive numbers. Split the array into the minimum<strong> </strong>number of subsets (or subsequences) such that each subset contains consecutive numbers.</span></p>
