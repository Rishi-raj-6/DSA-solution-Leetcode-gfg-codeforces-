...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/unoccupied-computers-1646661078/1)

## Solved On
02 Sept 2026 at 04:10 pm

<h2><a href="https://www.geeksforgeeks.org/problems/unoccupied-computers-1646661078/1">Unoccupied Computers</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">A cafe has n computers. The customer events are represented by a string s of uppercase English letters, where each distinct letter appears exactly twice:</span></p>
<ul>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ n ≤ 26<br>1 ≤ |s| ≤ 52<br></span><span style="font-size: 18px;">s consists of uppercase English letters and each letter occurs exactly 2 times.</span></p>