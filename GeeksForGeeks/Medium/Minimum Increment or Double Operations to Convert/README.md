...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/minimum-steps-to-get-desired-array5519/1)

## Solved On
06 Aug 2026 at 11:06 pm

<h2><a href="https://www.geeksforgeeks.org/problems/minimum-steps-to-get-desired-array5519/1">Minimum Increment or Double Operations to Convert</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18.6667px;">Given an array <strong>arr[]</strong>. Initially, you have another array containing only 0s.<br></span><span style="font-size: 18.6667px;">In one operation, you may either:</span></p>
<ul>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1 ≤ arr.size() ≤ 10<sup>5</sup><br>0 ≤ arr[i] ≤ 10<sup>9</sup></span></p>