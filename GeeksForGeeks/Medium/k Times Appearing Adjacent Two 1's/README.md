...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/count-binary-strings1944/1)

## Solved On
28 Jun 2026 at 02:32 am

<h2><a href="https://www.geeksforgeeks.org/problems/count-binary-strings1944/1">k Times Appearing Adjacent Two 1's</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18px;">Given two integers <strong>n</strong> and <strong>k</strong>, count the number of binary strings of length n where adjacent 1 appear k times. </span></p>
