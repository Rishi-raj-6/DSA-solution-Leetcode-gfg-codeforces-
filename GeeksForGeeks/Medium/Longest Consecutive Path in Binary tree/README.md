...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/longest-consecutive-sequence-in-binary-tree/1)

## Solved On
24 Jul 2026 at 11:27 pm

<h2><a href="https://www.geeksforgeeks.org/problems/longest-consecutive-sequence-in-binary-tree/1">Longest Consecutive Path in Binary tree</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 14pt;">Given the root of a Binary Tree</span><span style="font-size: 18px;">, find the length of the <strong>longest </strong>path consisting of connected nodes such that each next node has a value exactly 1 greater than its parent.</span></p>
