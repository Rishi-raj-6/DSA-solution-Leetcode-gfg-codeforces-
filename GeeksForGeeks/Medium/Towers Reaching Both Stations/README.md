...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/geeks-island--170646/1)

## Solved On
08 Jul 2026 at 11:13 pm

<h2><a href="https://www.geeksforgeeks.org/problems/geeks-island--170646/1">Towers Reaching Both Stations</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18px;">Given a matrix <strong>mat[][]</strong> of size <strong>n x m</strong>, where mat[i][j] represents the signal strength of a communication tower. Two control stations monitor the network:</span></p>
<ul>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ n, m </span><span style="font-size: 18px;">≤ 10</span><sup>3<br></sup><span style="font-size: 18px;">1 ≤ mat[i][j] ≤ 10<sup>3</sup>&nbsp;</span></p>