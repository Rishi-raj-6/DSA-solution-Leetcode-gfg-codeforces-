...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/count-of-n-digit-numbers-whose-sum-of-digits-equals-to-given-sum0733/1)

## Solved On
16 Jul 2026 at 01:43 am

<h2><a href="https://www.geeksforgeeks.org/problems/count-of-n-digit-numbers-whose-sum-of-digits-equals-to-given-sum0733/1">Numbers with Given Digit Sum</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18px;">Given two integers <strong>n</strong> and <strong>sum</strong>, determine the number of <strong>n-digit</strong> positive integers whose digits add up to sum.</span></p>
<ul>
