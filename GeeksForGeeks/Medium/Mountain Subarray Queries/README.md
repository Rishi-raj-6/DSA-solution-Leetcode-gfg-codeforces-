...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/mountain-subarray-problem/1)

## Solved On
20 Jul 2026 at 03:20 am
...
<p><span style="font-size: 18px;"><strong>Constraints:<br></strong></span><span style="font-size: 18px;">1 &lt;= arr.size(), queries.size() &lt;= 10<sup>5<br></sup></span><span style="font-size: 18px;">1 &lt;= arr[i] &lt;= 10<sup>6</sup><br></span><span style="font-size: 18px;">0 &lt;= l &lt;= r &lt; arr.size()</span></p>