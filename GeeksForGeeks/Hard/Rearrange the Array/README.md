...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/rearrange-the-array-1639032648/1)

## Solved On
13 Jul 2026 at 07:00 pm

<h2><a href="https://www.geeksforgeeks.org/problems/rearrange-the-array-1639032648/1">Rearrange the Array</a></h2><h3>Difficulty Level: Hard</h3><hr><p><span style="font-size: 18px;">Consider an array<strong> </strong></span><span style="font-size: 18px;"><strong>a[]</strong> = [1, 2, 3, ..., n] and a permutation <strong>b[]</strong> of size n containing all integers from 1 to n exactly once.</span></p>
<ul>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1&nbsp;<span style="font-size: 18.6667px;">≤</span>&nbsp;n&nbsp;<span style="font-size: 18.6667px;">≤</span>&nbsp;10<sup>4<br><span style="font-size: 14pt;">a.size() = b.size() = n</span><br></sup>b[] is a permutation of integers from 1 to n.</span></p>