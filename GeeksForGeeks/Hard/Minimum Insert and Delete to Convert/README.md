...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/minimum-insertions-to-make-two-arrays-equal/1)

## Solved On
30 Jun 2026 at 12:35 am

<h2><a href="https://www.geeksforgeeks.org/problems/minimum-insertions-to-make-two-arrays-equal/1">Minimum Insert and Delete to Convert</a></h2><h3>Difficulty Level: Hard</h3><hr><p><span style="font-size: 18px;">Given two arrays <strong>a[]</strong> and <strong>b[] </strong>of size n and m respectively, find the minimum number of <strong>insertions </strong>and <strong>deletions </strong>on the array a[], required to make both the arrays <strong>identical</strong>.</span></p>
...
<p><span style="font-size: 18px;"><strong>&nbsp;</strong></span><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ n, m ≤ 10<sup>5</sup><br>1 ≤ a[i], b[i] ≤ 10<sup>5</sup></span></p>